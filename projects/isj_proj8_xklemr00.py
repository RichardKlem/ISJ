...
def first_with_given_key(iterable, key=lambda x: x):
    ...
    :param iterable: povinný parametr iterable, odpovídající předanému iterovatelnému objektu (může být i nekonečný)
    :param key: nepovinný parametr key, odpovídající funkci, která při volání na položce objektu iterable vrátí hodnotu klíče,
